<?php
$recipient = 'dentalmedicaldevelopment@gmail.com'; // Enter the recipient's email address here.
$subject   = 'New contact from DMD.com.'; // Enter the subject of the email here.
